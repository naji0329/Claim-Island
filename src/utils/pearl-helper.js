...
export const getTextureFiles = (overtoneColour, bodyHSV) => {
  ...
  switch(overtoneColour) {
    case "rainbow":
      ...
      bodyHSV[2] < 40 ? envMapFile = "envmap-rainbow-dark.jpg" : envMapFile = "envmap-rainbow-light.jpg";
      break;

    case "peacock":
      emissiveFile = "emissive-peacock-2.jpg";
      bodyHSV[2] ? envMapFile = "envmap-peacock-dark.jpg" : envMapFile = "envmap-peacock-light.jpg";
      break;
...
export const getEmissiveIntensity = (bodyHSV, overtoneHSV, lustre) => {
  ...
  const overtoneVFactor = overtoneHSV[2] < 40 ? (100 - overtoneHSV[2]) / 100 * 2 : (100 - overtoneHSV[2]) / 100;
  const lustreFactor = lustre / 100;

  const eInt = 0.1 * bodySFactor + 0.15 * bodyVFactor + 0.05 *overtoneSFactor + 0.15 * overtoneVFactor + 0.15 * lustreFactor;
