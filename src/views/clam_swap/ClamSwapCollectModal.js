      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Card>
          <div className="flex flex-col mb-1">
            <h2 className="text-blue-700 font-semibold text-2xl mb-2">Clam Swap</h2>
            <a
              className="text-gray-500 text-base underline"
              href={getExplorerAddressLink(clamExchangeAddress, ChainId.BSC)}
              target="_blank"
              rel="noreferrer"
            >
              {clamExchangeAddress}
...
export default connect(mapToProps, actions)(ClamSwapCollectModal);
