...
const Saferoom = ({ account: { clamBalance, pearlBalance_, address }, updateCharacter }) => {
  ...
  const data = [
    {dna: "103140339436220929026525987155024116218033104851717941375485186660299742132116"},
    {dna: "2038873062315569189854844327658393601257384806182061205025327052537952117566"},
  ]
