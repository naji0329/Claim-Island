...
const Voting = () => {
  const [hasAccountVoted, setAlreadyVoted] = useState(true);
  ...
  const getPercVotes = (votes) => {
    ...
    if (sum > 0) {
      const val = parseFloat(((votes / sum) * 100).toFixed(2));
      return val;
    } else {
      return 0;
    }
                ...
                >
                  <div style={{ width: "100%" }}>
                    <span style={{ float: "right" }}>
                      {getPercVotes(oneVotes)}% ({oneVotes} votes)
                    </span>
                  ...
                  <Progress
                    style={{ clear: "both" }}
                    striped
                    value={getPercVotes(oneVotes)}
                    barStyle={{ backgroundColor: "#3869d9" }}
                  />
                </div>
              </li>
              <li>
                ...
                >
                  <div style={{ width: "100%" }}>
                    <span style={{ float: "right" }}>
                      {getPercVotes(twoVotes)}% ({twoVotes} votes)
                    </span>
                  ...
                  <Progress
                    style={{ clear: "both" }}
                    striped
                    value={getPercVotes(twoVotes)}
                    barStyle={{ backgroundColor: "#fdefc6" }}
                  />
                </div>
              </li>
              <li>
                ...
                >
                  <div style={{ width: "100%" }}>
                    <span style={{ float: "right" }}>
                      {getPercVotes(threeVotes)}% ({threeVotes} votes)
                    </span>
                    <span style={{ float: "left" }}>
                      When Clam Island Opens
                    </span>
                  </div>
                  <Progress
                    style={{ clear: "both" }}
                    striped
                    value={getPercVotes(threeVotes)}
                    barStyle={{ backgroundColor: "#23d0e3" }}
                  />
                </div>
              </li>
            </ul>
            ...
            <ul style={{ listStyle: "none" }}>
              ...
              >
                <Button
                  ...
                  onClick={() => vote(connectedAccount, 1)}
                >
                  Immediately
                </Button>
              </li>
              ...
              >
                <Button
                  ...
                  onClick={() => vote(connectedAccount, 2)}
                >
                  After Clam Presale
                </Button>
              </li>
              ...
              >
                <Button
                  ...
                  onClick={() => vote(connectedAccount, 3)}
                >
                  When Clam Island Opens
                </Button>
              </li>
