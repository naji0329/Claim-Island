  ...
  return (
    <>
      ...
      <div className="shell-presale">
        ...
        {hasNotStarted && <CharacterSpeak character={"tanja"} speech={"shell_presale_not_started"} setConnect={setConnect} /> }
        {!hasNotStarted && <CharacterSpeak character={"tanja"} speech={"shell_presale"} setConnect={setConnect} /> }
      </div>
    </>
  );
};
